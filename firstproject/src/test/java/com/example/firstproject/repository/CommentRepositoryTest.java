...
class CommentRepositoryTest {
    ...
    void findByArticleId() {
        ...
        /* Case3: 9번 게시글의 모든 댓글 조회 */
        {
            ...
            // 4. 비교 및 검증
            assertEquals(expected.toString(), comments.toString(), "9번 게시글 존재하지 않음!");
        }
        /* Case4: 999번 게시글의 모든 댓글 조회 */
        {
            ...
            // 4. 비교 및 검증
            assertEquals(expected.toString(), comments.toString(), "999번 게시글 존재하지 않음!");
        }
        /* Case5: -1번 게시글의 모든 댓글 조회 */
        {
            ...
            // 4. 비교 및 검증
            assertEquals(expected.toString(), comments.toString(), "-1번 게시글 존재하지 않음!");
        }
    }
    ...
    void findByNickname() {
        ...
        /* Case 3: null의 모든 댓글 조회 */
        {
            ...
            // 4. 비교 및 검증
            assertEquals(expected.toString(), comments.toString(), "사용자가 없음!");
        }
        /* Case 4: ""의 모든 댓글 조회 */
        {
            // 1. 입력 데이터 준비
